...
const About = () => {
    return (
        <section className="body-font boxShadow">
            <div className="max-w-7xl px-2 md:px-4 mx-auto py-20">
                <div className="mb-20 text-center max-w-3xl mx-auto">
                    <p className="font-ibm text-xl mb-6">
                        From wall tiles to commercial space design, from wood
                        flooring to kitchen backsplash - We've got it all!
                    </p>
                    <p className="font-ibm text-xl mb-3">
                        Visit us at Bhopal to go through
                    </p>
                    <h2 className="uppercase text-4xl font-medium font-hero">
                        Our Collection
                    </h2>
                </div>
                {/* collection 1 */}
                <div className="flex gap-8 items-center mb-16">
                    <div className="w-1/2 overflow-hidden sm:mt-0 backCol2 flex justify-start shadow-2xl">
                        <img src={abt1} alt="" width="100%" />
                    </div>
                    <div className="mt-auto mb-auto w-1/2">
                        <h1 className="font-ibm uppercase font-medium text-3xl mb-2">
                            Wall Tiles
                        </h1>
                        <p className="mt-3 text-xl font-ibm mb-4">
                        ...
                        <button className="float-right text-xl font-ibm uppercase bg-black text-white px-5 py-1">
                            Explore <i className="bi bi-chevron-right"></i>
                        </button>
                    </div>
                </div>
                {/* collection 2 */}
                <div className="flex flex-row-reverse gap-8 items-center mb-16">
                    <div className="w-1/2 overflow-hidden sm:mt-0 backCol2 flex justify-start shadow-2xl">
                        <img src={abt2} alt="" width="100%" />
                    </div>
                    <div className="mt-auto mb-auto w-1/2 text-right">
                        <h1 className="font-ibm uppercase font-medium text-3xl mb-2">
                            Wood Flooring
                        </h1>
                        <p className="mt-3 text-xl font-ibm mb-4">
                        ...
                        <button className="text-xl font-ibm uppercase bg-black text-white px-5 py-1">
                            Explore <i className="bi bi-chevron-right"></i>
                        </button>
                    </div>
                </div>
